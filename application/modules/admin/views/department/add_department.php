                ...
                <div class="row">
                	<div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="department_name" placeholder="Department Name" value="<?php echo set_value("department_name");?>">
                        </div>
					</div>
                	<div class="col-md-6">
                ...
                <div class="row">
                	<div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                            	<textarea class="cleditor" name="department_description"><?php echo set_value("department_description");?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
